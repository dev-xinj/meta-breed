...
exports.PageModule = PageModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([page_entity_1.Page]), axios_1.HttpModule],
        controllers: [page_controller_1.PageController],
        providers: [page_service_1.PageService, apiFacebook_service_1.ApiFacebook],
    })
], PageModule);
